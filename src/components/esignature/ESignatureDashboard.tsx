        ...
        return (
            <div className="animate-fade-in" style={{ maxWidth: '1200px', margin: '0 auto', height: 'calc(100vh - 100px)' }}>
                <button
                    ...
                    style={{ marginBottom: '1rem', background: 'none', border: 'none', color: '#6b7280', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem' }}
                >
                ...
                {wizardStep === 'upload' && (
                    <div style={{
                        ...
                        >
                            ...
                            <p style={{ color: '#6b7280', marginBottom: '2.5rem', fontSize: '1.125rem', lineHeight: 1.6, maxWidth: '400px', margin: '0 auto 2.5rem auto' }}>
                                Drag & drop your PDF or Word document here, or <span style={{ color: '#4f46e5', fontWeight: '600', textDecoration: 'underline', textUnderlineOffset: '2px' }}>browse files</span>
                            </p>
    ...
    return (
        <div className="animate-fade-in" style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', minHeight: '80vh', paddingBottom: '5rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2.5rem' }}>
                ...
                {/* Desktop "New Request" button can remain as secondary or standard access */}
                <button
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    {loading ? (
                        ...
                        <div style={{
                            ...
                            <button onClick={() => setView('create')} style={{ color: '#4f46e5', background: 'none', border: 'none', fontWeight: '600', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', margin: '0 auto' }}>
                                <Plus size={16} /> Create Request
                            </button>
                        </div>
                    ) : (
                        recentRequests.map((doc) => {
                            ...
                            const statusColor = isCompleted ? '#10b981' : isViewed ? '#0369a1' : '#b45309';
                            const statusBg = isCompleted ? '#ecfdf5' : isViewed ? '#f0f9ff' : '#fffbeb';
                            const statusBorder = isCompleted ? '#bbf7d0' : isViewed ? '#bae6fd' : '#fde68a';
